...
exports.handRank = handValue => {
    ...
    else if ( handValue > 3325 ) return "One pair";         // 2860 one pair
    else if ( handValue > 2467 ) return "Two pair";         //  858 two pair
    else if ( handValue > 1609 ) return "Three of a kind";  //  858 three-kind
    else if ( handValue > 1599 ) return "Straight";         //   10 straights
    else if ( handValue > 322 )  return "Flush";            // 1277 flushes
    else if ( handValue > 166 )  return "Full house";       //  156 full house
    else if ( handValue > 10 )   return "Four of a kind";   //  156 four-kind
    else return "Straight flush";                           //   10 straight-flushes
};
